export default function ProblemStatement() {
  return (
    <section
      className="w-full mx-auto px-8 py-20 rounded-xl shadow-xl border border-gray-100"
      style={{ backgroundColor: "var(--color-lightBg)" }}
    >
      <header className="max-w-3xl mx-auto text-center mb-12">
        <h2
          className="text-4xl font-extrabold tracking-tight relative inline-block"
        ...
        <div
          className="h-1 w-24 mx-auto rounded-full mt-4 animate-pulse"
          style={{ background: "linear-gradient(90deg, #A35A00, #F5A623, #FCD77F)" }}
        />
        <p
      ...
      <div className="px-40 grid md:grid-cols-2 gap-16">
        {/* Structural Problems Card */}
        <div
          className="rounded-xl p-8 shadow-lg hover:shadow-2xl transition-shadow duration-300 border"
          style={{
            background: "linear-gradient(135deg, var(--color-primary)1a, var(--color-secondary)14)",
        ...
        <div
          className="rounded-xl p-8 shadow-lg hover:shadow-2xl transition-shadow duration-300 border"
          style={{
            background: "linear-gradient(135deg, var(--color-secondary)1a, var(--color-accent)14)",
            borderColor: "var(--color-secondary)",
            color: "var(--color-darkBg)",
          }}
        >
      ...
      <div
        className="ml-40 mr-40 mt-16 rounded-xl p-8 shadow-xl flex flex-col md:flex-row justify-around items-center space-y-6 md:space-y-0"
        style={{
